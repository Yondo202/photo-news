                                                            ...
                                                            <div className="group1">
                                                                <div className="content">
                                                                    ...
                                                                    <div className="contentChild">
                                                                        ...
                                                                        <span className="value">{el.Vildver}</span>
                                                                    </div>
                                                                </div>
                                                                <div className="content content2">
                                                                    ...
                                                                    <div className="contentChild">
                                                                        ...
                                                                        <span className="value">{el.OrjIsenOn}он</span>
                                                                    </div>
                                                                </div>
                                                                <div className="content content2">
                                                                    <MdSystemUpdateAlt />
                                                                    <div className="contentChild">
                                                                        ...
                                                                        <span className="value">30км</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="group1">
                                                                <div className="content content2">
                                                                    ...
                                                                    <div className="contentChild">
                                                                        ...
                                                                        <span className="value">{el.VildverlesenOn}он</span>
                                                                    </div>
                                                                </div>
                                                                <div className="content">
                                                                    <GiCartwheel />
                                                                    <div className="contentChild">
                                                                        ...
                                                                        <span className="value">{el.Hodolgvvr}</span>
                                                                    </div>
                                                                </div>
                                                                <div className="content content2">
                                                                    <GiPoliceCar />
